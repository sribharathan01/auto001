...
def parse_offer_ids(input_str):
    # Split by comma or newline, strip whitespace, and filter out empty strings
...
if all([schema_file, offer_file, offer_ar_file, merchant_file, location_file, offer_ids_input]):
    ...
    st.info("Please enter offer IDs to filter.")

else:
    st.info("Please upload all required input files.")
